...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'calvinfirlansyah@sdnydx.onmicrosoft.com',
  ...
  email: 'mailto:calvinfirlansyah@x1bypass.my.id',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/qwerty-vin',
    },
  ],
